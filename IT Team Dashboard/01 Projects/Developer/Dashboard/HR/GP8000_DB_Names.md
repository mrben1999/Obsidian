...
| Cột | Kiểu dữ liệu | Giải nghĩa |
|---|---|---|
| `COU_ID` | NVARCHAR(3) NOT NULL | Huyện / Quận (Mã (khóa nhận diện))  ⚠️ *suy luận theo quy ước đặt tên, cần xác nhận lại* |
